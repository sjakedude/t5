...
{	
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "capture", 5000 );

	maps\mp\gametypes\_rank::registerScoreInfo( "defend", 500 );
	maps\mp\gametypes\_rank::registerScoreInfo( "defend_assist", 250 );

	maps\mp\gametypes\_rank::registerScoreInfo( "assault", 500 );
	maps\mp\gametypes\_rank::registerScoreInfo( "assault_assist", 250 );
